...
tf.app.flags.DEFINE_string('data_dir', '../data/Bi-Cu-V-307/data.npy','The path of input observation data')
tf.app.flags.DEFINE_string('batches_dir', '../data/Bi-Cu-V-307/200k-paths-len10.npy','The path of batches')
#tf.app.flags.DEFINE_string('batches_dir', '../data/Bi-Cu-V-307/paths-len10-balanced.npy','The path of batches')
#tf.app.flags.DEFINE_string('bases_sol_dir', '../data/Bi-Cu-V-307/bases_sol.npy','The path of *')
#tf.app.flags.DEFINE_string('weights_sol_dir', '../data/Bi-Cu-V-307/normalized_weights_sol.npy','The path of *')
tf.app.flags.DEFINE_string('weights_sol_dir', '../data/Bi-Cu-V-307/weights_sol.npy','The path of *')

#tf.app.flags.DEFINE_string('decomposition_sol_dir', '../data/Bi-Cu-V-307/decomposition_sol.npy','The path of *')
tf.app.flags.DEFINE_string('bases_comp_dir', '../data/Bi-Cu-V-307/real_lib_comp.npy','The path of *')
tf.app.flags.DEFINE_string('bases_name_dir', '../data/Bi-Cu-V-307/bases_name.npy','The path of *')
tf.app.flags.DEFINE_string('stick_bases_dir', '../data/Bi-Cu-V-307/sticks_lib.npy','The path of *')
tf.app.flags.DEFINE_string('edges_dir', '../data/Bi-Cu-V-307/edges.npy','The path of *')
tf.app.flags.DEFINE_string('bases_edge_dir', '../data/Bi-Cu-V-307/bases_edge.npy','The path of *')
tf.app.flags.DEFINE_string('Q_dir', '../data/Bi-Cu-V-307/Q_300.npy','The path of *')
tf.app.flags.DEFINE_string('Q_idx_dir', '../data/Bi-Cu-V-307/Q_idx_300.npy','The path of *')
tf.app.flags.DEFINE_string('importance_dir', '../data/Bi-Cu-V-307/importance.npy','The path of *')
tf.app.flags.DEFINE_string('sample_indicator_dir', '../data/Bi-Cu-V-307/sample_indicator.npy','The path of *')
...
tf.app.flags.DEFINE_string('degree_of_freedom_dir', '../data/Bi-Cu-V-307/degree_of_freedom.npy','The path of *')
...
tf.app.flags.DEFINE_integer('batch_size', 10, 'the number of data points in one minibatch') #128
tf.app.flags.DEFINE_integer('testing_size', 307, 'the number of data points in one testing or validation batch') #128
...
tf.app.flags.DEFINE_float('alloy_decay', 1.0, '*')
...
tf.app.flags.DEFINE_float('smooth_weights_th', 0.00, 'threshold of *')
tf.app.flags.DEFINE_float('shift_amplify', 0.0003, '*')
tf.app.flags.DEFINE_float('shift_unit', 0.001, '*')
...
tf.app.flags.DEFINE_float('intensity_shift', 1.5, '*') # 1.5
...
tf.app.flags.DEFINE_integer('n_spike', 160, '#spikes')
...
tf.app.flags.DEFINE_integer('n_bases', 100, '#library bases ')
...
tf.app.flags.DEFINE_integer('xrd_dim', 2016, 'the dimensionality of the xrd features ')
tf.app.flags.DEFINE_integer('compressed_xrd_dim', 300, 'the dimensionality of the compressed xrd features ')
