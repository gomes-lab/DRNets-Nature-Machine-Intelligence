...
parser.add_argument("--all_diff", default=0.0, type=float)
parser.add_argument("--entropy_cell", default=0.0, type=float)
...
pred_path = "./models/pred.model-noreason"
sep_path = "./models/sep.model-noreason"
sep2_path = "./models/sep2.model-noreason"
...
check_freq = int(args.clip_step // batch_size)
    ...
    for idx in indices:
        ...
        if (len(s_mix_lst) == batch_size):
            ...
            for ii in range(epochs):
                ...
                #print (gen_labels1.size())
                #print (z1.view(-1, 100).size())
                #print (z1.size())
                ...
                #print (gen_imgs.size())
                #exit(-1)
                #save_image(gen_img1, "images/mnist%d.png" % (_epoch_), nrow=9)
                #save_image(gen_img2, "images/upper%d.png" % (_epoch_), nrow=9)
                #print ("size: !", gen_img1.size(), " ", gen_imgs.size())
               ...
               # 0.005
                ...
                if (_epoch_ < 5 and args.mode == "train"):
                    ...
                    loss = args.scale_recon * loss_recon +  args.entropy_cell * entropy_cell_drop - args.all_diff * (entropy_alldiff_drop)
            ...
            if (cnt % check_freq == 0):
                ...
                (cnt * batch_size, all_sudoku_acc/cnt, all_label_acc/cnt, all_recon_loss/cnt, best_acc))
                
                avg_sudoku_acc = all_sudoku_acc/cnt
                if (avg_sudoku_acc > best_acc):
                    best_acc = avg_sudoku_acc
...
save_data(pred_probs1, "noreason-res/pred_probs1")
save_data(pred_probs2, "noreason-res/pred_probs2")
save_data(gt_labels1, "noreason-res/gt_labels1")
save_data(gt_labels2, "noreason-res/gt_labels2")
