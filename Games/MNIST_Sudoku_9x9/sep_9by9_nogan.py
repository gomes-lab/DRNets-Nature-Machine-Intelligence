...
parser.add_argument("--entropy_cell", default=0.1, type=float)
parser.add_argument("--scale_recon", default=0.005, type=float)
parser.add_argument("--mode", default="train", type=str)
parser.add_argument("--model_idx", default="nogan", type=str)
    ...
    for idx in indices:
        ...
        if (len(s_mix_lst) == batch_size):
            ...
            for ii in range(epochs):
                ...
                optimizer = torch.optim.Adam(list(pred.parameters()) + list(sep.parameters()) + list(sep2.parameters()) + list(generator_digit.parameters()) + list(generator_upper.parameters()), lr=lr)
